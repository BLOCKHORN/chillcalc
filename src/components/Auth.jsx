    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-bg-app">
      <div className="card w-full max-w-md p-8 shadow-2xl border-brand-500/20">
        ...
        <button
          ...
          className="w-full bg-white text-gray-900 border border-gray-200 rounded-xl px-4 py-3.5 font-bold flex items-center justify-center gap-3 transition-all hover:bg-gray-50 active:scale-95 disabled:opacity-70 disabled:active:scale-100 shadow-sm"
        >
          {loadingGoogle ? (
        ...
        <div className="flex items-center my-6">
          ...
          <span className="px-4 text-[10px] font-black text-text-muted uppercase tracking-widest">O usa tu email</span>
          <div className="flex-1 border-t border-border-subtle"></div>
        </div>
