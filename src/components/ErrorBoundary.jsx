    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-black flex flex-col items-center justify-center p-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-white mb-3 tracking-tight">Ups, algo ha fallado</h1>
          ...
          <button 
            ...
            className="mt-10 px-8 py-4 rounded-xl bg-white text-black font-bold text-[14px] flex items-center gap-3 hover:scale-105 transition-all"
          >
